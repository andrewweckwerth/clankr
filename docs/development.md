...
The development compose file exposes the frontend at `http://localhost:3000`, PostgreSQL on `127.0.0.1:5432`, Redis on `127.0.0.1:6379`, MinIO on `127.0.0.1:9000`, its console at `http://127.0.0.1:9001`, the classifier on `127.0.0.1:8001`, and Ollama on `127.0.0.1:11434`. Other services are reachable only inside the Compose network.
